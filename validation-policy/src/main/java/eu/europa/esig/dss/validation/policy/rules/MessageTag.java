...
public enum MessageTag {
	...
	BBB_SAV_ISQPMTP("Is signed qualifying property: 'mime-type' present?"),
	BBB_SAV_ISQPMTP_ANS("The signed qualifying property: 'mime-type' doesn't match constraints or is absent!"),
	BBB_SAV_ISQPCTP("Is signed qualifying property: 'content-type' present?"),
	BBB_SAV_ISQPCTP_ANS("The signed qualifying property: 'content-type' doesn't match constraints or is absent!"),
