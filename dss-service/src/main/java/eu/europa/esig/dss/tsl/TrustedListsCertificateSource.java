...
public class TrustedListsCertificateSource extends CommonTrustedCertificateSource {
	...
	protected File tslPropertyCacheFolder = new File(System.getProperty("java.io.tmpdir"));
	protected Properties tslHashes = null;
	protected Properties tslNextUpdates = null;
	...
	protected Map<String, String> diagnosticInfo = new HashMap<String, String>();
